        ...
        return (
            <div className={styles.page}>
                <div className="container-xl py-4 text-center">
                    <div className="spinner-border text-teal" style={{ width: "3rem", height: "3rem" }}></div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="row g-4">
                            ...
                            <div className="col-md-6">
                                ...
                                />
                                <small className={styles.helpText}>Mã robot không thể thay đổi</small>
                            </div>
                                ...
                                {form.compartments.map((c, i) => (
                                    <div key={i} className={styles.compartmentCard}>
                                        ...
                                        <div className={styles.compartmentCode}>
                                            ...
                                            Mã ngăn: <strong>C{i + 1 < 10 ? '00' : '0'}{i + 1}</strong>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="col-12 text-end mt-4">
                                ...
                                >
                                    ...
                                    {saving ? "Đang lưu..." : <><i className="bi bi-check-circle me-1"></i> Lưu thay đổi</>}
                                </button>
                            </div>
