...
namespace API_Powered_Hospital_Delivery_Robot.Tests.Controllers
{
    public class MapsUploadController_CreateMap_Tests
    {
        ...
        private readonly Mock<ILogger<MapsUploadController>> _loggerMock;
        ...
        public MapsUploadController_CreateMap_Tests()
        {
            ...
            _loggerMock = new Mock<ILogger<MapsUploadController>>();
        ...
        [Fact]
        public async Task UploadJson_UTCD01_FullValid_ShouldReturn201()
        {
            var req = CreateValidRequest("Map_Tang1");
            var expected = CreateFakeResponse(req.MapName);

            _uploadServiceMock
                .Setup(s => s.UploadJsonAsync(It.IsAny<MapUploadJsonDto>()))
            ...
            var body = Assert.IsType<MapResponseDto>(objectResult.Value);
            Assert.Equal(expected.Id, body.Id);
            Assert.Equal(expected.MapName, body.MapName);

            _uploadServiceMock.Verify(
                s => s.UploadJsonAsync(It.IsAny<MapUploadJsonDto>()),
                Times.Once);
        }

        [Fact]
        public async Task UploadJson_UTCD02_NoImage_ShouldReturn201()
        {
            ...
            _uploadServiceMock
                .Setup(s => s.UploadJsonAsync(
                    It.Is<MapUploadJsonDto>(d => 
                        d.ImageBase64 == null && d.ImageName == null)))
        ...
        [Fact]
        public async Task UploadJson_UTCD03_MapNameOneChar_ShouldReturn201()
        {
        ...
        [Fact]
        public async Task UploadJson_UTCD04_MapName255Chars_ShouldReturn201()
        {
        ...
        [Fact]
        public async Task UploadJson_UTCD05_ResolutionVerySmall_ShouldReturn201()
        {
            ...
            _uploadServiceMock
                .Setup(s => s.UploadJsonAsync(
                    It.Is<MapUploadJsonDto>(d => d.Resolution == req.Resolution)))
                .ReturnsAsync(CreateFakeResponse(req.MapName));
        ...
        [Fact]
        public async Task UploadJson_UTCD06_ResolutionLarge_ShouldReturn201()
        {
            ...
            _uploadServiceMock
                .Setup(s => s.UploadJsonAsync(
                    It.Is<MapUploadJsonDto>(d => d.Resolution == 1.0f)))
                .ReturnsAsync(CreateFakeResponse(req.MapName));
        ...
        public async Task UploadJson_UTCD07_ResolutionNotPositive_ShouldReturn500()
        {
            ...
            _uploadServiceMock
                .Setup(s => s.UploadJsonAsync(
                    It.Is<MapUploadJsonDto>(d => d.Resolution <= 0)))
        ...
        public async Task UploadJson_UTCD08_MapNameEmpty_ShouldReturn500()
        {
            ...
            _uploadServiceMock
                .Setup(s => s.UploadJsonAsync(
                    It.Is<MapUploadJsonDto>(d => string.IsNullOrWhiteSpace(d.MapName))))
        ...
        public async Task UploadJson_UTCD09_MapNameNull_ShouldReturn500()
        {
            ...
            _uploadServiceMock
                .Setup(s => s.UploadJsonAsync(
                    It.Is<MapUploadJsonDto>(d => d.MapName == null)))
                .ThrowsAsync(new ArgumentException("MapName is required"));
        ...
        [Fact]
        public async Task UploadJson_UTCD10_InvalidBase64_ShouldReturn500()
        {
            // Service sẽ validate base64, không phải controller
        ...
        [Fact]
        public async Task UploadJson_UTCD11_ImageNameNull_ShouldReturn201()
        {
        ...
        public async Task UploadJson_UTCD12_OccupiedLessOrEqualFree_ShouldReturn500()
        {
            ...
            _uploadServiceMock
                .Setup(s => s.UploadJsonAsync(
                    It.Is<MapUploadJsonDto>(d => d.OccupiedThresh <= d.FreeThresh)))
        ...
        [Fact]
        public async Task UploadJson_UTCD14_OriginVeryLarge_ShouldReturn201()
        {
        ...
        [Fact]
        public async Task GetImage_MapNotFound_Returns404()
        {
            _mapServiceMock.Setup(s => s.GetByIdAsync(999))
                           .ReturnsAsync((MapResponseDto?)null);
        ...
        [Fact]
        public async Task GetImage_NoImageData_Returns404()
        {
            var mapDto = CreateFakeResponse("Map_NoImage");
            mapDto.ImageData = null;
