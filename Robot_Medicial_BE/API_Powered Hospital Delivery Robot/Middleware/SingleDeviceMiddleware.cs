...
namespace API_Powered_Hospital_Delivery_Robot.Middleware
{
    /// <summary>
    /// Middleware kiểm tra đăng nhập một thiết bị (chỉ cho phép một session active)
    /// </summary>
    public class SingleDeviceMiddleware
    {
        ...
        /// <summary>
        /// Xử lý request và kiểm tra session token
        /// </summary>
